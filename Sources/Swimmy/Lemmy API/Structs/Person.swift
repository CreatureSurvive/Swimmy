...
public struct Person: Codable, Identifiable, Hashable, Sendable {
    ...
    public init(actor_id: String, admin: Bool? = nil, avatar: String? = nil, ban_expires: String? = nil, banned: Bool, banner: String? = nil, bio: String? = nil, bot_account: Bool, deleted: Bool, display_name: String? = nil, id: Int, inbox_url: String? = nil, instance_id: Int, local: Bool, matrix_user_id: String? = nil, name: String, published: String, shared_inbox_url: String? = nil, updated: String? = nil) {
