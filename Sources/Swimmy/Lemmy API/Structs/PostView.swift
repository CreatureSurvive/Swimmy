...
public struct PostView: Codable, Hashable {
    ...
    public init(community: Community, counts: PostAggregates, creator: Person, creator_banned_from_community: Bool, creator_blocked: Bool, my_vote: Int? = nil, post: Post, read: Bool, saved: Bool, subscribed: SubscribedType, unread_comments: Int) {
