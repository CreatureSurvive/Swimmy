...
public struct PrivateMessageReportView: Codable, Hashable, Sendable {
    ...
    public init(creator: Person, private_message: PrivateMessage, private_message_creator: Person, private_message_report: PrivateMessageReport, resolver: Person? = nil) {
